...
if TYPE_CHECKING:
    # Element base is already defined above in your file
    class Html(Element): ...
    class Head(Element): ...
    class Title(Element): ...
    class Base(Element): ...
    ...
    # Provide a *literal* __all__ for analyzers (runtime __all__ stays below)
    __all__ = [
        # Core + CSS + helpers (match your runtime list)
        ...
        # Elements (non-abbreviated)
        "Html","Head","Title","Base","Link","Meta","Style",
        "Body","Address","Article","Aside","Footer","Header",
        "Heading1","Heading2","Heading3","Heading4","Heading5","Heading6","HeadingGroup","Main","Navigation","Section",
        "BlockQuote","DescriptionDetails","Division","DescriptionList","DescriptionTerm","FigureCaption","Figure","HorizontalRule","ListItem","Menu","OrderedList","Paragraph","PreformattedText","UnorderedList",
        "Anchor","Abbreviation","Bold","BidirectionalIsolation","BidirectionalOverride","LineBreak","Citation","Code","Data","Definition","Emphasis","Italic","KeyboardInput","Mark","Quotation","RubyParenthesis","RubyText","RubyAnnotation","Strikethrough","SampleOutput","Small","Span","Strong","Subscript","Superscript","Time","Underline","Variable","WordBreakOpportunity",
        "Deletion","Insertion",
        "MapArea","Audio","Image","ImageMap","Track","Video","Embed","InlineFrame","Object","Parameter","Picture","Source",
        "Canvas","NoScript","Script","Slot","Template",
        "TableCaption","TableColumn","TableColumnGroup","Table","TableBody","TableDataCell","TableFooter","TableHeaderCell","TableHead","TableRow",
        "Button","DataList","FieldSet","Form","Input","Label","Legend","Meter","OptionGroup","Option","Output","Progress","Select","TextArea",
        "Details","Dialog","Summary","Portal",
    ]
